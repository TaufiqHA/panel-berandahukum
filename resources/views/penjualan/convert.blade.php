...
<div class="section-header">
    <h1>Convert Penjualan Toko</h1>
    <div class="section-header-breadcrumb">
        <div class="breadcrumb-item active"><a href="#">Convert Penjualan Toko</a></div>
    </div>
</div>
    ...
    function getDetailBarang() {
        ...
        $.each(data.detail_quotation, function (i,v) {
            ...
            detail_barang += '<div class="form-row row-detail-barang" id="row_barang_'+row_edit+'" data-id="'+row_edit+'">'+
                ...
                '<div class="form-group col-md-1">'+
                    '<label>Jumlah</label>'+
                    '<input value="'+v.jumlah+'" type="number" min="0" name="jumlah" id="jumlah_'+row_edit+'" class="form-control edit_detail_barang jumlah" required data-id="'+row_edit+'" readonly>'+
