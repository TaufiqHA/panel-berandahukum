...
<div class="section-header">
    <h1>Detail Invoice Toko</h1>
    <div class="section-header-breadcrumb">
        <div class="breadcrumb-item active"><a href="#">Detail Invoice Toko</a></div>
    </div>
</div>
...
<div class="section-body">
    ...
    <p class="section-lead">
        Berikut adalah data detail invoice toko melindastore</a>.
    </p>
    <div class="row">
        <div class="col-12">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control" required="" id="date" name="date"
                                    placeholder="Tanggal" value="{{ date('d F Y', strtotime($invoice->date)) }}"
                                    readonly>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select class="form-control select2" required="" id="nama_sales" name="nama_sales" disabled>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" required="" id="nama_pembeli"
                                    name="nama_pembeli" value="{{ $invoice->nama_pembeli }}" readonly>
                                <div class="invalid-feedback feedback-nama_toko">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" id="alamat_pembeli" name="alamat_pembeli"
                                    value="{{ $invoice->alamat_pembeli }}" readonly>
                                <div class="invalid-feedback feedback-nama_toko">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" id="telepon" name="telepon"
                                    value="{{ $invoice->telepon }}" readonly>
                                <div class="invalid-feedback feedback-nama_toko">
                                    Alamat Pembeli harus diisi.
                                </div>
                            </div>
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <form class="needs-validation-payment" novalidate="">
                        <div class="row">
                            <div class="form-group {{ $invoice->waktu != "" ? "col-md-3" : "col-md-4" }} row_pertama">
                            ...
                            <div class="form-group {{ $invoice->waktu != "" ? "col-md-3" : "col-md-4" }} row_pertama"
                                ...
                                <input type="text" class="form-control" required="" id="tempo_waktu" name="tempo_waktu"
                                    required value="{{ $invoice->waktu }}" disabled>
                                <div class="invalid-feedback feedback-status_pembayaran">
                            ...
                            @else
                            <div
                                class="form-group {{ $invoice->waktu != "" ? "col-md-3" : "col-md-4" }} row_pertama div_ppn">
                                <label>Total</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-4">
                                ...
                                <div class="form-group row div_ppn" id="div-ppn">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" required="" name="grand_total"
                                            id="grand_total"
                                            value="{{ number_format($invoice->subtotal + ($invoice->subtotal * 11 / 100)) }}"
                                            readonly>
                                ...
                                @endif
                                @if ($invoice->payment_status == 'Tempo' || $invoice->payment_status == 'DP')
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">DP</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control money-format" name="dp_payment"
                                            id="dp_payment" value="{{ number_format($invoice->dp_payment) }}" readonly>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" required="" name="sisa" id="sisa"
                                            value="{{ number_format($invoice->sisa) }}" readonly>
