        ...
        <div class="col-12">
                    ...
                    <form class="needs-validation" novalidate="">
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                <label>Date</label>
                                <input type="text" class="form-control datepicker" required="" id="date" name="date" placeholder="Tanggal" min="1" value="{{ date('d-m-Y', strtotime($quotation->date)) }}">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" required="" id="nama_pembeli" name="nama_pembeli" value="{{ $quotation->nama_pembeli }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" id="telepon_pembeli" name="telepon_pembeli" value="{{ $quotation->telepon }}">
                                <div class="invalid-feedback feedback-nama_toko_from">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
								<input {{ $quotation->show_option == 1 ? "checked" : "" }} class="form-check-input" type="checkbox" value="1" name="show_option" id="show_option"
                                ...
                                <input type="text" class="form-control" id="option_text"
                                    name="option_text" placeholder="Masukan option text disini"  value="{{ $quotation->option_text }}">
                                <div class="invalid-feedback feedback-option_text">
                                    Option Text harus diisi.
                                </div>
                            </div>
                            <div class="form-group col-md-6">
								<input {{ $quotation->show_project == 1 ? "checked" : "" }} class="form-check-input" type="checkbox" value="1" name="show_project" id="show_project"
                                    style="margin-left: 0px;cursor: pointer;">
                                <label class="form-check-label" for="show_project" style="margin-left: 1.25rem;">
                                    Nama Project
                                </label>
                                <br />
                                <input type="text" class="form-control" id="nama_project" name="nama_project" placeholder="Masukan nama project disini" value="{{ $quotation->nama_project }}">
                                <div class="invalid-feedback feedback-nama_toko_from">
            ...
            <div class="card card-primary">
                    ...
                    <form class="needs-validation-payment" novalidate="">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                <input class="form-check-input" type="checkbox" {{ $quotation->ppn != 0 ? "checked": "" }} id="flexCheckDefault"
                                    style="margin-left: 0px;cursor: pointer;">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea class="form-control" name="keterangan_pembayaran" id="keterangan_pembayaran"
                                    style="height: 150px;">{{ $quotation->keterangan }}</textarea>
                                <div class="invalid-feedback feedback-keterangan_pembayaran">
                                    Keterangan harus diisi.
                                </div>
                                <br />
                                <input {{ $quotation->show_infopembayaran == 1 ? "checked" : "" }} class="form-check-input" type="checkbox" value="1" name="show_infopembayaran" id="show_infopembayaran"
                                    style="margin-left: 0px;cursor: pointer;">
                ...
                <div class="card-footer text-right">
					<button class="btn btn-danger" data-id="batal" type="button" id="draft">Batal</button>
...
$(document).ready(function() {
    ...
    function getDetailBarang() {
        ...
        $.each(data.detail_quotation, function (i,v) {
            ...
            if(data.barang[i].wajib_serial_number != 1){
