...
<div class="section-header">
    <h1>Detail PO Toko</h1>
    <div class="section-header-breadcrumb">
        <div class="breadcrumb-item active"><a href="#">Detail PO Toko</a></div>
    </div>
</div>

<div class="section-body">
    <h2 class="section-title">Detail PO</h2>
                    ...
                    <form class="needs-validation" novalidate="">
                        <div class="form-row">
                            <div class="form-group col-md-3 col-sm-3">
                                ...
                                <input type="text" readonly class="form-control datepicker" required="" id="date" name="date"
                                    placeholder="Tanggal" value="{{ date('d-m-Y', strtotime($po->date)) }}">
                             ...
                             <div class="form-group col-md-3 col-sm-3">
                                ...
                                <select disabled class="form-control select2" id="nama_purchase" name="nama_purchase">
                                    ...
                                    @foreach($all_signatures as $signature)
                                        <option value="{{ $signature->name }}" {{ $po->nama_purchase == $signature->name ? 'selected' : '' }}>{{ $signature->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4 col-sm-4">
                                ...
                                <input type="text" readonly class="form-control" required="" id="nama_supplier"
                                    name="nama_supplier" value="{{ $po->nama_supplier }}">
                            ...
                            <div class="form-group col-md-4 col-sm-4">
                                ...
                                <input type="text" readonly class="form-control" id="alamat_supplier" name="alamat_supplier" value="{{ $po->alamat_supplier }}">
                                <div class="invalid-feedback feedback-nama_supplier">
                            ...
                            <div class="form-group col-md-4 col-sm-4">
                                ...
                                <input type="text" readonly class="form-control" id="telepon" name="telepon" value="{{ $po->telepon }}">
                                <div class="invalid-feedback feedback-nama_supplier">
                                    Alamat Supplier harus diisi.
                                </div>
                            </div>
                    ...
                    <form class="needs-validation-payment" novalidate="">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <textarea readonly class="form-control" name="keterangan" id="keterangan"
                                    style="height: 150px;">{{ $po->keterangan }}</textarea>
                            ...
                            <div class="form-group col-md-6">
                                <div class="mt-1">
                                    <div class="mt-1 div_ppn" style="{{ $po->ppn != 0 ? "": "display:none" }}">
                                        <label
                                        ...
                                        <input type="text" class="form-control" required="" name="input_total"
                                            id="input_total" value="{{ number_format($po->subtotal) }}" readonly>
                                        <div class="invalid-feedback feedback-input_ppn">
                                            Grand Total harus diisi.
                                        </div>
                                    </div>
                                    <div style="{{ $po->ppn != 0 ? "": "display:none" }}" class="mt-1 div_ppn">
                                        <label
                                        ...
                                        <input type="text" class="form-control" required="" name="input_ppn" id="input_ppn"
                                             readonly value="{{ number_format($po->ppn) }}">
                                        <div class="invalid-feedback feedback-input_ppn">
                                            PPN harus diisi.
                                        </div>
                                    </div>
                                    <div class="mt-1">
                                        ...
                                        <input type="text" class="form-control" required="" name="sub_total" id="sub_total"
                                            value="{{ $po->ppn != 0 ? number_format($po->subtotal + ($po->subtotal * 11 /100)) : number_format($po->subtotal) }}" readonly>
                                        <div class="invalid-feedback feedback-sub_total">
                                            Total harus diisi.
                                        </div>
                                    </div>

                                    <div style="{{ $po->po_dp > 0 ? "" : "display: none;" }}" class="mt-1 div_dp">
                                        <label
                                    ...
                                    <div style="{{ $po->po_dp > 0 ? "" : "display: none;" }}" class="mt-1 div_dp">
                                        ...
                                        <input type="text" class="form-control money-format sisapem" required="" readonly name="input_sisa" id="input_sisa"
                                            value="{{ $po->ppn != 0 ? number_format( ($po->subtotal + ($po->subtotal * 11 /100)) - $po->po_dp ) : number_format($po->subtotal - $po->po_dp) }}" readonly>
                                        <div class="invalid-feedback feedback-input_dp">
                            ...
                            {{-- <div class="form-group col-md-6">
                                ...
                                <input type="text" readonly class="form-control" required="" name="sub_total"
                                    id="sub_total" readonly value="{{ number_format($po->subtotal) }}">
                                <div class="invalid-feedback feedback-sub_total">
...
<script type="text/javascript">
    ...
    function getDetailBarang() {
        ...
        $.each(data.detail_po, function (i,v) {
            ...
            let url_toko_edit = "{{ url('barang/toko') }}/"+$('#nama_supplier').val();
            let url_toko = "{{ url('barang/toko') }}/"+$('#nama_supplier').val();
            let subtotal;
    ...
    $(document).on("select2:select","#nama_supplier", function(e){
        $("#nama_supplier_to").select2({
            placeholder: "Pilih Toko",
            ajax: {
    ...
    $(document).on("select2:select",".nama_barang", function(e){
        let id = $(this).data('id');
        let data = {}
        data.id_toko = $('#nama_supplier').val();
        ...
        let url = "{{ url('serial-number/id_toko/') }}/"+$('#nama_supplier').val()+"/id_barang/"+$(this).val();
    ...
    $(document).on("select2:select",".edit_nama_barang", function(e){
        let url = "{{ url('serial-number/id_toko/') }}/"+$('#edit_nama_supplier').val()+"/id_barang/"+$(this).val();
        $("#serial_number_"+$(this).data('id')).select2({
            placeholder: "Pilih Serial Number",
            ajax: {
                url: url,
